  ...
  return (
    ...
    >
      <Flex gap={'6px'} align={'center'}>
        {<props.icon boxSize={'18px'} fill={'currentcolor'} />}
...
export default function SideBar() {
  ...
  const menus: Menu[] = [
    ...
    {
      id: 'refund',
      url: '/refundpages/refund',
      value: t('common:refund_management'),
      icon: ReciptIcon,
      display: true
    },
    {
      id: 'payRecord',
      url: '/payment_record/payRecord',
      value: t('common:pay_record_management'),
      icon: ReciptIcon,
      display: true
    },
    {
